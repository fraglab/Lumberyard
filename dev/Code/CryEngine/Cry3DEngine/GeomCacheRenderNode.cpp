...
_smart_ptr<IMaterial> CGeomCacheRenderNode::GetMaterial(Vec3* pHitPos)
{
    if (m_pMaterial)
    {
        return m_pMaterial;
...
void CGeomCacheRenderNode::FillRenderObject(const SRendParams& rendParams, const SRenderingPassInfo& passInfo, _smart_ptr<IMaterial> pMaterial, CRenderObject* pRenderObject)
{
    FUNCTION_PROFILER_3DENGINE;
