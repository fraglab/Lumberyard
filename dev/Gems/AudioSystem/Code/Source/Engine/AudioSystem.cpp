...
namespace Audio
{
    ...
    void CAudioSystem::PushRequest(const SAudioRequest& audioRequestData)
    {
        ...
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::PushRequest - called from non-Main thread!");
    ...
    void CAudioSystem::PushRequestBlocking(const SAudioRequest& audioRequestData)
    {
        ...
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::PushRequestBlocking - called from non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::AddRequestListener - called from a non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::RemoveRequestListener - called from a non-Main thread!");
    ...
    {
        // Main Thread!
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::ExternalUpdate - called from non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::Initialize - called from a non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::Release - called from a non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::ReserveAudioListenerID - called from a non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::ReleaseAudioListenerID - called from a non-Main thread!");
    ...
    {
    #if defined(INCLUDE_AUDIO_PRODUCTION_CODE)
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::RefreshAudioSystem - called from a non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::GetFreeAudioProxy - called from a non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::FreeAudioProxy - called from a non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::GetAudioControlName - called from non-Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::GetAudioSwitchStateName - called from non-Main thread!");
        const char* sResult = nullptr;
    ...
    void CAudioSystem::ProcessRequestByPriority(CAudioRequestInternal request)
    {
        ...
        AZ_Assert(gEnv->mTickThreadId != CryGetCurrentThreadId(), "AudioSystem::ProcessRequestByPriority - called from Main thread!");
    ...
    {
        AZ_Assert(gEnv->mTickThreadId == CryGetCurrentThreadId(), "AudioSystem::DrawAudioDebugData - called from non-Main thread!");
